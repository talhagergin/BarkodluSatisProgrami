...
namespace BarkodluSatis
{
    static class Raporlar
    {
        ...
        public static void RaporSayfasiRaporu(DataGridView dgv)
        {
            ...
            FrmRaporGoster f = new FrmRaporGoster();
            f.reportViewer.LocalReport.DataSources.Clear();
            f.reportViewer.LocalReport.DataSources.Add(rs);
            f.reportViewer.LocalReport.ReportPath = Application.StartupPath + @"\rpGenelRapor.rdlc";
            ...
            f.reportViewer.LocalReport.SetParameters(prm);
            f.reportViewer.SetDisplayMode(Microsoft.Reporting.WinForms.DisplayMode.PrintLayout);
            f.reportViewer.ZoomMode = ZoomMode.PageWidth;
            f.ShowDialog();
        ...
        public static void StokRaporu(DataGridView dgv)
        {
            ...
            f.reportViewer.LocalReport.DataSources.Clear();
            f.reportViewer.LocalReport.DataSources.Add(rs);
            f.reportViewer.LocalReport.ReportPath = Application.StartupPath + @"\rpStokUrun.rdlc";
        ...
        public static void StokIzlemeRaporu(DataGridView dgv)
        {
            ...
            f.reportViewer.LocalReport.DataSources.Clear();
            f.reportViewer.LocalReport.DataSources.Add(rs);
            f.reportViewer.LocalReport.ReportPath = Application.StartupPath + @"\rpStokIzleme.rdlc";
            ReportParameter[] prm = new ReportParameter[3];
            prm[0] = new ReportParameter("Baslik", Baslik);
            prm[1] = new ReportParameter("TarihBaslangic", TarihBaslangic);
            prm[2] = new ReportParameter("TarihBitis", TarihBitis);
